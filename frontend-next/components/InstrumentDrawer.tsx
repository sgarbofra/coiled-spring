    ...
    <div className="fixed inset-0 z-50 flex justify-end bg-black/50">
      <div className="h-full w-full max-w-xl overflow-y-auto bg-slate-950 p-6 text-slate-100 shadow-2xl">
        <div className="mb-6 flex items-center justify-between">
          ...
          <button onClick={onClose} className="rounded border border-slate-700 px-3 py-2 text-sm">
            Close
          </button>
        </div>
        ...
        <div className="mt-6 flex gap-2">
          <button onClick={() => onSave(form)} className="rounded bg-emerald-600 px-4 py-2 text-sm font-medium">
            Save changes
          </button>
